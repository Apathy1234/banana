...
(cl:in-package mynteye_wrapper_d-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Temp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Temp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mynteye_wrapper_d-msg:<Temp> is deprecated: use mynteye_wrapper_d-msg:Temp instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Temp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mynteye_wrapper_d-msg:header-val is deprecated.  Use mynteye_wrapper_d-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Temp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mynteye_wrapper_d-msg:data-val is deprecated.  Use mynteye_wrapper_d-msg:data instead.")
  (data m))
