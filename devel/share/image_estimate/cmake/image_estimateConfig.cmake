...
if(image_estimate_CONFIG_INCLUDED)
  return()
endif()
set(image_estimate_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(image_estimate_SOURCE_PREFIX /home/tg/my_slam/src/image_estimate)
  set(image_estimate_DEVEL_PREFIX /home/tg/my_slam/devel)
  set(image_estimate_INSTALL_PREFIX "")
  set(image_estimate_PREFIX ${image_estimate_DEVEL_PREFIX})
else()
  set(image_estimate_SOURCE_PREFIX "")
  set(image_estimate_DEVEL_PREFIX "")
  set(image_estimate_INSTALL_PREFIX /home/tg/my_slam/install)
  set(image_estimate_PREFIX ${image_estimate_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'image_estimate' is deprecated")
...
set(image_estimate_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/tg/my_slam/src/image_estimate/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(image_estimate_INCLUDE_DIRS "")
  set(_include_dirs "/home/tg/my_slam/src/image_estimate/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(image_estimate_LIBRARY_DIRS ${lib_path})
      list(APPEND image_estimate_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'image_estimate'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND image_estimate_LIBRARIES ${lib})
    endif()
  endif()
...
set(image_estimate_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${image_estimate_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 image_estimate_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${image_estimate_dep}_FOUND)
      find_package(${image_estimate_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${image_estimate_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(image_estimate_INCLUDE_DIRS ${${image_estimate_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(image_estimate_LIBRARIES ${image_estimate_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${image_estimate_dep}_LIBRARIES})
  _list_append_deduplicate(image_estimate_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(image_estimate_LIBRARIES ${image_estimate_LIBRARIES})

  _list_append_unique(image_estimate_LIBRARY_DIRS ${${image_estimate_dep}_LIBRARY_DIRS})
  list(APPEND image_estimate_EXPORTED_TARGETS ${${image_estimate_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${image_estimate_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
