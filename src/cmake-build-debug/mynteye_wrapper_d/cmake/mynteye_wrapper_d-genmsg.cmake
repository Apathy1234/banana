...
message(STATUS "mynteye_wrapper_d: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imynteye_wrapper_d:/home/tg/my_slam/src/mynteye_wrapper_d/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tg/my_slam/src/mynteye_wrapper_d/msg/Temp.msg" NAME_WE)
add_custom_target(_mynteye_wrapper_d_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mynteye_wrapper_d" "/home/tg/my_slam/src/mynteye_wrapper_d/msg/Temp.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(mynteye_wrapper_d
  "/home/tg/my_slam/src/mynteye_wrapper_d/msg/Temp.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_eus(mynteye_wrapper_d
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/mynteye_wrapper_d
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(mynteye_wrapper_d_generate_messages_eus
...
# target for backward compatibility
add_custom_target(mynteye_wrapper_d_geneus)
add_dependencies(mynteye_wrapper_d_geneus mynteye_wrapper_d_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS mynteye_wrapper_d_generate_messages_eus)
...
### Generating Module File
_generate_module_nodejs(mynteye_wrapper_d
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mynteye_wrapper_d
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(mynteye_wrapper_d_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(mynteye_wrapper_d_gennodejs)
add_dependencies(mynteye_wrapper_d_gennodejs mynteye_wrapper_d_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS mynteye_wrapper_d_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/mynteye_wrapper_d)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/mynteye_wrapper_d
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(mynteye_wrapper_d_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mynteye_wrapper_d)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mynteye_wrapper_d
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(mynteye_wrapper_d_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
